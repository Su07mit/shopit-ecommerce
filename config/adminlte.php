    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu'   => [
                ...
                [
                    'text'  => 'Stocks',
                    'url'   => 'admin/stocks',
                    'icon'  => 'nav-icon fas fa-fw fa-warehouse'
                ],

                [
                    'text'  => 'Attributes',
                    'url'   => 'admin/attributes',
                    'icon'  => 'nav-icon fas fa-fw fa-list-ul'
                ],

                [
                    'text'  => 'Sliders',
                    'url'   => 'admin/sliders',
                    'icon'  => 'nav-icon fas fa-fw fa-photo-video'
                ],
            ]
        ],
        ...
        [
            'text' => 'Promotions',
            'url'  => '#',
            'icon'  => 'nav-icon fas fa-fw fa-atom',
            'submenu'   => [
                [
                    'text'  => 'Coupon Codes',
                    'url'   => 'admin/coupons',
